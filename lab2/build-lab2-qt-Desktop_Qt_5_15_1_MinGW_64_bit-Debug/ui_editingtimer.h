...
public:
    ...
    void setupUi(QDialog *EditingTimer)
    {
        ...
        EditingTimer->resize(400, 280);
        EditingTimer->setMinimumSize(QSize(400, 280));
        EditingTimer->setMaximumSize(QSize(400, 280));
        btnCancel = new QPushButton(EditingTimer);
        btnCancel->setObjectName(QString::fromUtf8("btnCancel"));
        btnCancel->setGeometry(QRect(240, 230, 61, 31));
        QFont font;
        font.setPointSize(11);
        btnCancel->setFont(font);
        lineEditName = new QLineEdit(EditingTimer);
        lineEditName->setObjectName(QString::fromUtf8("lineEditName"));
        lineEditName->setGeometry(QRect(60, 90, 271, 41));
        QFont font1;
        ...
        timeEditTime->setGeometry(QRect(100, 160, 201, 41));
        QFont font3;
