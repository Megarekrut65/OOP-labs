...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/images/start-all.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/prefix1/images/pause-all.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/prefix1/images/delete-all.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/new/prefix1/images/start.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/new/prefix1/images/pause.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/new/prefix1/images/delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuTools->addAction(actionStart_selected_timer);
        menuTools->addAction(actionPause_selected_timer);
        menuTools->addAction(actionDelete_selected_timer);
