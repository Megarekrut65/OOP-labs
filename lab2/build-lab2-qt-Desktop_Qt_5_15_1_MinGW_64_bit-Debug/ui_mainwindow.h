...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lblTitle->setGeometry(QRect(320, 10, 291, 31));
        QFont font;
        ...
        listTimers->setGeometry(QRect(320, 50, 301, 251));
        QFont font3;
        font3.setFamily(QString::fromUtf8("Shruti"));
        ...
        listTimers->setAlternatingRowColors(true);
